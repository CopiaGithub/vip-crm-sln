...
(function (GCPL) {
    ...
    (function (Controller) {
        var app = GCPL.app;
        var TeamLeadController = /** @class */ (function (_super) {
            __extends(TeamLeadController, _super);
        ...
        app.AddController("TeamLeadController", TeamLeadController);
    })(Controller = GCPL.Controller || (GCPL.Controller = {}));
})(GCPL || (GCPL = {}));
//# sourceMappingURL=TeamLeadController.js.map