namespace GCPL.Service {
    ...
    export interface IViewQuotationService {

        Find(data: any): ng.IPromise<Utility.Ajax.IResponse>;
        GetQuote(data: any): model.ViewQuoteModel;

    }
    export class ViewQuotationService extends GCPL.Service.BaseService implements IViewQuotationService {
        ...
        GetQuote(data: any): model.ViewQuoteModel {
            ...
            let obj = new model.ViewQuoteModel();
