    ...
    (function (Component) {
        ...
        (function (Home) {
            ...
            var LeadChangeController = /** @class */ (function () {
                ...
                LeadChangeController.prototype.$onInit = function () {
                    var that = this;
                    this.Init();
                    $("#errorclose").hide();
                ...
                LeadChangeController.prototype.Init = function () {
                    var _this = this;
                    debugger;
                    var that = this;
                    $('#Campaignfield').hide();
                ...
                LeadChangeController.prototype.State = function (data) {
                    var _this = this;
                ...
                LeadChangeController.prototype.District = function (data) {
                    var _this = this;
                ...
                LeadChangeController.prototype.AddConState = function (data) {
                    var _this = this;
                ...
                LeadChangeController.prototype.AddConDistrict = function (data) {
                    var _this = this;
                ...
                LeadChangeController.prototype.Division = function (data) {
                    var _this = this;
                ...
                LeadChangeController.prototype.Product = function (data) {
                    var _this = this;
                ...
                LeadChangeController.prototype.Model = function (data) {
                    var _this = this;
                ...
                LeadChangeController.prototype.LeadSource = function (data) {
                    var _this = this;
                ...
                LeadChangeController.prototype.LeadStatusopen = function (data) {
                    var _this = this;
                    this.LeadStatusOpenDD = this.LeadStatusForOpenDDService.Find(this.LeadID).then((function (response) {
                        _this.LeadStatusOpenDD = _this.LeadStatusForOpenDDService.GetLeadOpen(response.data.Result);
                    }));
                };
                LeadChangeController.prototype.Campaign = function () {
                    var _this = this;
                ...
                LeadChangeController.prototype.LeadSourceChange = function () {
                    $("#Campaignfield").hide();
                    $("#UserNamefield").hide();
                ...
                LeadChangeController.prototype.LeadOpenReason = function () {
                    var _this = this;
                ...
                LeadChangeController.prototype.HideShow = function () {
                    $("#errorclose").show();
                    $("#close").hide();
                };
                LeadChangeController.prototype.popupMessage = function (Message, AddClass, RemoveClass, ShowImg, HideImg) {
                ...
                LeadChangeController.prototype.Submit = function (data) {
                    var _this = this;
                ...
                LeadChangeController.prototype.Edit = function (data) {
                    var _this = this;
                    debugger;
                ...
                LeadChangeController.prototype.Reset = function () {
                    this.Edit(this.LeadID);
                    if (this.LeadID > 0) {
                        $("#errorclose").hide();
                        $("#close").show();
                ...
                LeadChangeController.prototype.Close = function () {
                    location.href = "#!/LeadChangeList";
                };
                LeadChangeController.$inject = ["LeadChangeEditService", "ReasonForLeadOpenDDService", "LeadStatusForOpenDDService",
                    ...
                    "$location", "$cookieStore", "CampaignDetailsService", "UserCodeAutoFillService"];
                return LeadChangeController;
            }());
            var LeadChangeComponentController = /** @class */ (function () {
                function LeadChangeComponentController() {
                    this.controller = LeadChangeController;
                    this.templateUrl = "/Scripts/App/LeadChange/Template/LeadChange.html";
                }
                LeadChangeComponentController.Name = "leadchange";
                return LeadChangeComponentController;
            }());
            app.AddComponent(LeadChangeComponentController.Name, new LeadChangeComponentController());
        })(Home = Component.Home || (Component.Home = {}));
    })(Component = GCPL.Component || (GCPL.Component = {}));
})(GCPL || (GCPL = {}));
//# sourceMappingURL=LeadChangeComponent.js.map