        ...
        (function (Home) {
            ...
            var CreateContactController = /** @class */ (function () {
                ...
                function CreateContactController(_CountryService, _StateService, _DistrictService, _DesignationService, _DepartmentService, _CustomerSapAutofill, _InsertService, _EditService, $location, _cookieStore, _PullContactService, _InsertSAPService) {
                    ...
                    this.DeliveryDetailsModel = null;
                ...
                CreateContactController.prototype.TSAssignmentCart = function () {
                ...
                CreateContactController.prototype.Submit = function () {
                    ...
                    if (this.TSAssignmentList == null || this.TSAssignmentCart == undefined) {
                        ...
                        for (var i = 0; i < this.TSAssignmentList.length; i++) {
                            ...
                            this.InsertSAPService.PostCreateInSAP(this.DeliveryDetailsModel).then(function (response) {
                                if (flag == 0) {
                                    $("#errorclose").hide();
                                    $("#close").show();
