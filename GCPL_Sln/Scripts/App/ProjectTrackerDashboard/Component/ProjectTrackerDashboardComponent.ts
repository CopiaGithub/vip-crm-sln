namespace GCPL.Component.Home {
    ...
    interface IProjectTrackerDashboardController {
    ...
    class ProjectTrackerDashboardController implements IProjectTrackerDashboardController {
        ...
        Search(): void {
            ...
            this.ProjectAssign();
            this.ProjectTrackerDashboardService.Find(this.ProjectDashboardSearch, "1").then((response => {
                debugger;
    ...
    class ProjectTrackerDashboardComponentController implements ng.IComponentOptions {
        static Name: string = "projecttrackerdashboardcomponent"
        public bindings: any;
