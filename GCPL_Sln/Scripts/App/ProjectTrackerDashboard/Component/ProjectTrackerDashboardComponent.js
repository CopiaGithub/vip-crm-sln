...
(function (GCPL) {
    ...
    (function (Component) {
        ...
        (function (Home) {
            ...
            var ProjectTrackerDashboardController = /** @class */ (function () {
                //constructor define with Serivce _Name:Service.IServiceName//
                function ProjectTrackerDashboardController(_getAutoProjectName, _ZoneDDService, _ProjectStageService, _ProjectSourceService, _ProjectIndustryService, _ProjectType, _CustProjectTypeService, _cookieStore, _ProjectTrackerDashboardService, _MultipleUserMasterService, _getAutoSalesrep1) {
                ...
                ProjectTrackerDashboardController.prototype.$onInit = function () {
                    this.Init();
                    this.ProjectAssignDropdownList = [];
                    $(".date-pick").datepicker();
                };
                ProjectTrackerDashboardController.prototype.selectFromDate = function (e) {
                    document.getElementById("txtFromDate").value = e;
                };
                ProjectTrackerDashboardController.prototype.selectToDate = function (e) {
                    document.getElementById("txtToDate").value = e;
                };
                //Page Load Define Values//
                ProjectTrackerDashboardController.prototype.Init = function () {
                    var _this = this;
                ...
                ProjectTrackerDashboardController.prototype.ProjectAssign = function () {
                    var _this = this;
                ...
                ProjectTrackerDashboardController.prototype.addUser = function (abc, abc_name, checkUser) {
                    debugger;
                    if (checkUser == true) {
                ...
                ProjectTrackerDashboardController.prototype.Search = function () {
                    var _this = this;
                    debugger;
                    this.ProjectDashboardSearch.ProjectStartDate = document.getElementById("txtFromDate").value;
                    this.ProjectDashboardSearch.CompletionDate = document.getElementById("txtToDate").value;
                    ...
                    this.ProjectAssign();
                    this.ProjectTrackerDashboardService.Find(this.ProjectDashboardSearch, "1").then((function (response) {
                        debugger;
                ...
                ProjectTrackerDashboardController.prototype.ModelDataDrawGraph = function (arrayData) {
                    debugger;
                ...
                ProjectTrackerDashboardController.prototype.LeadStatusDataDrawGraph = function (arrayData) {
                    debugger;
                    var pieData = arrayData;
                    var pieOptions = {
                        segmentShowStroke: false,
                ...
                ProjectTrackerDashboardController.prototype.OpportunityDataDrawGraph = function (arrayData) {
                    debugger;
                    var pieData = arrayData;
                    var pieOptions = {
                        segmentShowStroke: false,
                ...
                ProjectTrackerDashboardController.prototype.DivisionDataDrawGraph = function (arrayData) {
                    debugger;
                    var pieData = arrayData;
                    var pieOptions = {
                        segmentShowStroke: false,
                ...
                ProjectTrackerDashboardController.prototype.TypeDataDrawGraph = function (arrayData) {
                    debugger;
                    var pieData = arrayData;
                    var pieOptions = {
                        segmentShowStroke: false,
                ...
                ProjectTrackerDashboardController.prototype.SourceDataDrawGraph = function (arrayData) {
                    debugger;
                    var pieData = arrayData;
                    var pieOptions = {
                        segmentShowStroke: false,
                ...
                ProjectTrackerDashboardController.prototype.IndustryDataDrawGraph = function (arrayData) {
                    debugger;
                    var pieData = arrayData;
                    var pieOptions = {
                        segmentShowStroke: false,
                ...
                ProjectTrackerDashboardController.prototype.StageDataDrawGraph = function (arrayData) {
                    debugger;
                    var pieData = arrayData;
                    var pieOptions = {
                        segmentShowStroke: false,
                ...
                ProjectTrackerDashboardController.prototype.ZoneDataDrawGraph = function (arrayData) {
                    debugger;
                    var pieData = arrayData;
                    var pieOptions = {
                        segmentShowStroke: false,
                ...
                ProjectTrackerDashboardController.prototype.AssignToDataDrawGraph = function (arrayData) {
                    debugger;
                    var pieData = arrayData;
                    var pieOptions = {
                        segmentShowStroke: false,
                ...
                ProjectTrackerDashboardController.prototype.Clear = function () {
                ...
                ProjectTrackerDashboardController.$inject = ["getAutoProjectNameService", "ZoneDDService", "ProjectStageService",
                ...
                return ProjectTrackerDashboardController;
            }());
            var ProjectTrackerDashboardComponentController = /** @class */ (function () {
                function ProjectTrackerDashboardComponentController() {
                    this.controller = ProjectTrackerDashboardController;
                    this.templateUrl = "/Scripts/App/ProjectTrackerDashboard/Template/ProjectTrackerDashboard.html";
                }
                ProjectTrackerDashboardComponentController.Name = "projecttrackerdashboardcomponent";
                return ProjectTrackerDashboardComponentController;
            }());
            app.AddComponent(ProjectTrackerDashboardComponentController.Name, new ProjectTrackerDashboardComponentController());
        })(Home = Component.Home || (Component.Home = {}));
    })(Component = GCPL.Component || (GCPL.Component = {}));
})(GCPL || (GCPL = {}));
//# sourceMappingURL=ProjectTrackerDashboardComponent.js.map