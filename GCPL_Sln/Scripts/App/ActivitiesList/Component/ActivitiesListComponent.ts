namespace GCPL.Component.Home {
    ...
    interface IActivitiesListController {
        ActivityList: Array<Model.ActlistModel>;
    ...
    class ActivitiesListController implements IActivitiesListController {
        ...
        private Listservice: Service.IActListService;
        ...
        static $inject = ["ActListService", "ActSAPListService", "EditService", "InsertActService", "UserActivityService",
        ...
        constructor(_Listservice: Service.IActListService, _ActSAPListService: Service.IActSAPListService, _EditService: Service.IEditService, _InsertService: Service.IInsertActService,
            ...
            _ContactInfoService: Service.ILeadContactDetailsService, _CreateInSAPActivityService: Service.ICreateInSAPActivityService, private _cookieStore: any) {
            ...
            this.ActivitySearch = Array<GCPL.Model.ActSearchModel>();
        ...
        SearchActList(NoOfRecords): void {
            var that = this;
            that.incre = 0;
            ...
            this.ActivityList = this.Listservice.Find(this.ActivitySearch).then((response => {
                this.ActivityList = this.Listservice.GetUserActList(response.data.Result);
                $('#search-btn-loader').hide();

                this.ActivityList.forEach(function (value, key) {
                ...
                this.shownItems = this.ActivityList.slice(0, that.numRecords);
            }));
        }
        ...
        Edit(data: any): void {
            ...
            this.EditService.Find(data).then((response => {
                ...
                console.log("this.InsertAct111111",this.InsertAct);
    ...
    class ActivitiesListComponentController implements ng.IComponentOptions {
        static Name: string = "activitieslistcomponent"
        public bindings: any;
