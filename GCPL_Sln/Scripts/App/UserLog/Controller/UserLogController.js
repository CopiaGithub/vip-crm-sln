...
(function (GCPL) {
    ...
    (function (Controller) {
        var app = GCPL.app;
        var UserLogController = /** @class */ (function (_super) {
            __extends(UserLogController, _super);
        ...
        app.AddController("UserLogController", UserLogController);
    })(Controller = GCPL.Controller || (GCPL.Controller = {}));
})(GCPL || (GCPL = {}));
//# sourceMappingURL=UserLogController.js.map