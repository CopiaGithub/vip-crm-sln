...
(function (GCPL) {
    ...
    (function (Service) {
        ...
        var EditQuotationService = /** @class */ (function (_super) {
            __extends(EditQuotationService, _super);
            function EditQuotationService($http, $q, _cookieStore) {
            ...
            EditQuotationService.prototype.Find = function (data) {
            ...
            EditQuotationService.prototype.EditQuote = function (data) {
                var obj = new model.EditQuoteModel();
            ...
            EditQuotationService.$inject = ["$http", "$q", "$cookieStore"];
            return EditQuotationService;
        }(GCPL.Service.BaseService));
        Service.EditQuotationService = EditQuotationService;
...
(function (GCPL) {
    ...
    (function (Service) {
        var app = GCPL.app;
        var UpdateQuotationService = /** @class */ (function (_super) {
            __extends(UpdateQuotationService, _super);
            function UpdateQuotationService($http, $q, _cookieStore) {
                var _this = _super.call(this, $http, $q) || this;
                _this.$http = $http;
                _this.$q = $q;
                _this._cookieStore = _cookieStore;
                _this.apiUrl = "";
                _this.Cookie = null;
                _this.apiUrl = _this.url + "/" + "UpdateQuotation";
                _this.Cookie = _cookieStore;
                return _this;
            }
            UpdateQuotationService.prototype.Find = function () {
                return this.ajaXUtility.Get({ Url: this.apiUrl });
            };
            UpdateQuotationService.prototype.PostQuote = function (data) {
                var url = this.apiUrl;
                // console.log(url);
                return this.ajaXUtility.Post({ Url: url, data: data });
            };
            UpdateQuotationService.$inject = ["$http", "$q", "$cookieStore"];
            return UpdateQuotationService;
        }(GCPL.Service.BaseService));
        Service.UpdateQuotationService = UpdateQuotationService;
...
(function (GCPL) {
    ...
    (function (Service) {
        var app = GCPL.app;
        var ProdFeatService = /** @class */ (function (_super) {
            __extends(ProdFeatService, _super);
            function ProdFeatService($http, $q, _cookieStore) {
                var _this = _super.call(this, $http, $q) || this;
                _this.$http = $http;
                _this.$q = $q;
                _this._cookieStore = _cookieStore;
            ...
            ProdFeatService.prototype.Find = function (data) {
            ...
            ProdFeatService.prototype.GetProdF = function (data) {
                var list = Array();
            ...
            ProdFeatService.$inject = ["$http", "$q", "$cookieStore"];
            return ProdFeatService;
        }(GCPL.Service.BaseService));
        Service.ProdFeatService = ProdFeatService;
...
(function (GCPL) {
    ...
    (function (Service) {
        var app = GCPL.app;
        var EditTermsConditionService = /** @class */ (function (_super) {
            __extends(EditTermsConditionService, _super);
            function EditTermsConditionService($http, $q, _cookieStore) {
                var _this = _super.call(this, $http, $q) || this;
                _this.$http = $http;
                _this.$q = $q;
                _this._cookieStore = _cookieStore;
            ...
            EditTermsConditionService.prototype.Find = function (data) {
            ...
            EditTermsConditionService.prototype.GetTC = function (data) {
                var list = Array();
            ...
            EditTermsConditionService.$inject = ["$http", "$q", "$cookieStore"];
            return EditTermsConditionService;
        }(GCPL.Service.BaseService));
        Service.EditTermsConditionService = EditTermsConditionService;
        app.AddService("EditTermsConditionService", EditTermsConditionService);
    })(Service = GCPL.Service || (GCPL.Service = {}));
})(GCPL || (GCPL = {}));
//# sourceMappingURL=EditQuotationService.js.map