...
(function (GCPL) {
    ...
    (function (Controller) {
        var app = GCPL.app;
        var UserDashboardController = /** @class */ (function (_super) {
            __extends(UserDashboardController, _super);
        ...
        app.AddController("UserDashboardController", UserDashboardController);
